        ...
        return(
            ...
            ></input>
                        ...
                        <div id="show_respective">
                            ...
                            <pre>Information:  <input type="text" id="handout" readOnly style={{width:"40%"}}></input></pre>
                            <pre>Mid-Sem date:  <input type="text" id="mids" readOnly style={{width:"40%"}}></input></pre>
                            <pre>End-Sem date:   <input type="text" id="compre" readOnly style={{width:"40%"}}></input></pre>
                            <h3>Feedbacks:</h3>
                            {this.show_cards()}
                        </div>
                </div>
