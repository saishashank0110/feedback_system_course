            ...
            <div className="entire_div_profile">
                ...
                <div className="side_main_box">
                    ...
                    <div id="modify_div" style={{border:'1px solid',width:'fit-content',padding:'5%',marginLeft:'30%',borderRadius:'20px'}}>
                        <form>
                        <pre className="tab"><label>course id:           <input type="text" id="c_id" placeholder="select from above"></input></label></pre>
                            <pre className="tab"><label>course name:     <input type="text" id="c_name"></input></label></pre>
                            <pre className="tab"><label>information:    <input type="text" id="hand"></input></label></pre>
                            <pre className="tab"><label>credits:       <input type="number" id="cred"></input></label></pre>
                            <pre className="tab"><label>Mid sem:           <input type="date" id="mid"></input></label></pre>
                            <pre className="tab"><label>End sem:      <input type="date" id="compre"></input></label></pre>
                        </form>
